...
class RandomComputerPlayer(Player):
    ...
    def get_move(self,game):
        ...
        print(f"RandomComputerPlayer ({self.letter}) selected square: {square}")  # Debug statement
        return square
...
class HumanPlayer(Player):
    ...
    def get_move(self, game):
        ...
        print(f"HumanPlayer ({self.letter}) selected square: {val}")  # Debug statement
        return val
    
class GOATComputerPlayer(Player):
    def __init__(self, letter):
        super().__init__(letter)
