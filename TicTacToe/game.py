...
import time
from player import HumanPlayer, RandomComputerPlayer, GOATComputerPlayer

class TicTacToe:
    def __init__(self):
        self.board = [' 'for _ in range(9)] #we will use a sigle list to rep 3x3 board
...
def play(game, x_player, o_player, print_game=True):
    ...
    while game.empty_squares():
        ...
        print(f"{letter} selected square: {square}")
